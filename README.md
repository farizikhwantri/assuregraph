...
**Recommended placement: Use this image here, in the “Overview of the Framework” section (above), as it visually contrasts human vs LLM argument structures — matching the core motivation of the paper.**
